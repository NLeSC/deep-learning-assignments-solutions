...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        Args:
            X (numpy array): Input data of shape (N, D). Each X[i] is a training sample.
            y (vector): Vector of training labels. y[i] is the label for X[i], and each y[i] is
